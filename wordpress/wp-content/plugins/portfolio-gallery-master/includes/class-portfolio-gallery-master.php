...
class Portfolio_Gallery_Master {
	...
	public function __construct() {
		...
		$this->plugin_name = 'portfolio-gallery-master';
		$this->version = '1.0.0';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Portfolio_Gallery_Master_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Portfolio_Gallery_Master_Public( $this->get_plugin_name(), $this->get_version() );
